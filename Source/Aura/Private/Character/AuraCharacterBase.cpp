...
UNiagaraSystem* AAuraCharacterBase::GetBloodEffectSystem_Implementation()
{
	return BloodEffectSystem;
}

FTaggedMontage AAuraCharacterBase::GetTaggedMontageByTag_Implementation(const FGameplayTag& MontageTag)
{
	for (FTaggedMontage InTaggedMontage : AttackMontages)
	{
		if (InTaggedMontage.MontageTag == MontageTag)
		{
			return InTaggedMontage;
		}
	}
